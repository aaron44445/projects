...
import { Search, Calendar, Clock, User, Scissors, Loader2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        {submitError && (
          <div className="p-4 bg-rose/10 dark:bg-rose/20 border border-rose/20 dark:border-rose/30 rounded-xl text-rose-dark dark:text-rose text-sm">
            {submitError}
          </div>
        )}

        {submitSuccess && (
          <div className="p-4 bg-sage/10 dark:bg-sage/20 border border-sage/20 dark:border-sage/30 rounded-xl text-sage-dark dark:text-sage text-sm flex items-center gap-2">
      ...
      {/* Footer with actions */}
      <div className="flex gap-3 pt-6 border-t border-charcoal/10 dark:border-white/10 mt-6">
        <button
          onClick={onClose}
