              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-12 py-3 rounded-xl border border-charcoal/20 dark:border-white/20 bg-white dark:bg-charcoal text-charcoal dark:text-white focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={`w-full pl-12 pr-12 py-3 rounded-xl border outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white ${
                      confirmPassword.length > 0
                        ? passwordsMatch
                          ? 'border-sage focus:ring-2 focus:ring-sage/20'
                          : 'border-rose-300 focus:ring-2 focus:ring-rose-100'
                        : 'border-charcoal/20 dark:border-white/20 focus:border-sage focus:ring-2 focus:ring-sage/20'
                    }`}
                    disabled={isSubmitting}
                  />
                  <button
