          ...
          {!allRequiredComplete && (
            <div className="mb-6 bg-white dark:bg-sidebar rounded-2xl border border-border dark:border-white/10 shadow-soft overflow-hidden">
              ...
              <button
                ...
                className="w-full px-5 py-4 flex items-center justify-between hover:bg-charcoal/5 dark:hover:bg-white/5 transition-colors"
              >
                ...
                <div className="flex items-center gap-3">
                  {/* Progress bar */}
                  <div className="w-24 h-2 bg-charcoal/10 dark:bg-white/10 rounded-full overflow-hidden">
                    <div
                  ...
                  {setupChecklistCollapsed ? (
                    <ChevronDown className="w-5 h-5 text-charcoal/40 dark:text-white/40" />
                  ) : (
                    <ChevronUp className="w-5 h-5 text-charcoal/40 dark:text-white/40" />
                  )}
                </div>
              </button>
                      ...
                      <div
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl transition-colors ${
                          item.completed
                            ...
                            : 'bg-charcoal/5 dark:bg-white/5 hover:bg-charcoal/10 dark:hover:bg-white/10'
                        }`}
                      >
                        {/* Checkbox */}
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${
                          item.completed
                            ? 'bg-sage text-white'
                            : 'border-2 border-charcoal/20 dark:border-white/20'
                        }`}>
                        ...
                        <Icon className={`w-5 h-5 flex-shrink-0 ${
                          item.completed ? 'text-sage' : 'text-charcoal/40 dark:text-white/40'
                        }`} />
                        <span className={`flex-1 ${
                          ...
                          {item.label}
                          {item.optional && (
                            <span className="ml-2 text-xs text-charcoal/40 dark:text-white/40 font-normal">(optional)</span>
                          )}
                        </span>
          ...
          {activeAddOns.length > 0 && (
            <div className="mb-8">
              ...
              {isTrialActive && trialEndsAt && (
                <div className="bg-gradient-to-r from-sage/10 to-lavender/10 dark:from-sage/20 dark:to-lavender/20 rounded-2xl p-4 mb-6 border border-sage/20 dark:border-sage/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <Sparkles className="w-5 h-5 text-sage" />
                      <div>
                  ...
                  {activeAddOns.map((addOnId) => {
                    ...
                    return (
                      <button
                        ...
                        className="p-4 rounded-xl bg-cream/50 dark:bg-white/5 border border-charcoal/5 dark:border-white/10 hover:border-sage/30 hover:bg-sage/5 dark:hover:bg-sage/10 transition-all text-left group"
                      >
              ...
              <div className="fixed inset-y-0 right-0 w-full max-w-lg bg-white dark:bg-sidebar shadow-2xl z-50 overflow-auto">
                ...
                <div className="p-6 space-y-6">
                  <div className="bg-sage/10 dark:bg-sage/20 rounded-xl p-4">
                    <p className="text-charcoal dark:text-white">{ADD_ON_DETAILS[showSetupGuide].description}</p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-charcoal dark:text-white mb-4">How to set up</h3>
                      ...
                      {ADD_ON_DETAILS[showSetupGuide].setupSteps.map((step, index) => (
                        <div key={index} className="flex gap-4">
                          ...
                          <div className="flex-1 pt-1">
                            <p className="text-charcoal dark:text-white">{step}</p>
                          </div>
                        </div>
                      ))}
                    </div>
