            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.country ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.address ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.city ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.state ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                    placeholder="Region"
                  />
                  {fieldErrors.state && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.zip ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border ${fieldErrors.website ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
              ...
              <div className="bg-white rounded-xl border border-charcoal/10 p-6 space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg border ${cardErrors.cardNumber ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                    />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="MM/YY"
                      maxLength={5}
                      className={`w-full px-4 py-3 rounded-lg border ${cardErrors.expiry ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                    />
                    {cardErrors.expiry && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="123"
                        maxLength={4}
                        className={`w-full px-4 py-3 rounded-lg border ${cardErrors.cvc ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                      />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${cardErrors.nameOnCard ? 'border-rose-500' : 'border-charcoal/20 dark:border-white/20'} focus:border-sage focus:ring-2 focus:ring-sage/20 outline-none transition-all bg-white dark:bg-charcoal text-charcoal dark:text-white`}
                  />
                  ...
                  {day.isOpen && (
                    <div className="flex items-center gap-2 ml-auto">
                      <input
                        ...
                        className="px-3 py-2 rounded-lg border border-charcoal/20 dark:border-white/20 focus:border-sage outline-none text-sm bg-white dark:bg-charcoal text-charcoal dark:text-white"
                      />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-7 pr-3 py-2 rounded-lg border border-charcoal/20 dark:border-white/20 focus:border-sage outline-none text-sm bg-white dark:bg-charcoal text-charcoal dark:text-white"
                            placeholder="0"
                          />
                        </div>
                      </div>
