...
function ClientsContent() {
  ...
  // Handle book button click - navigate to calendar with client pre-selected
  const handleBookAppointment = (client: Client, e?: React.MouseEvent) => {
    e?.stopPropagation();
    // Navigate to calendar with client context
    router.push(`/calendar?clientId=${client.id}&clientName=${encodeURIComponent(`${client.firstName} ${client.lastName}`)}`);
  };
