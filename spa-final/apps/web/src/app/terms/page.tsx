        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sage/10 border border-sage/20 mb-6">
              ...
              <span className="text-sm font-medium text-charcoal">Legal Agreement</span>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-charcoal/5 shadow-card p-8 lg:p-12">
            ...
            <TermsSection
              ...
              content={
                <>
                  <h4 className="font-semibold text-charcoal mb-2">Account Creation</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Account Security</h4>
                  <ul className="list-disc list-inside text-charcoal/80 mb-4 space-y-1">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Eligibility</h4>
                  <p className="text-charcoal/80 leading-relaxed">
            ...
            <TermsSection
              ...
              content={
                <>
                  <h4 className="font-semibold text-charcoal mb-2">Pricing and Billing</h4>
                  <ul className="list-disc list-inside text-charcoal/80 mb-4 space-y-1">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Payment Processing</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Refunds</h4>
                  <ul className="list-disc list-inside text-charcoal/80 mb-4 space-y-1">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Failed Payments</h4>
                  <p className="text-charcoal/80 leading-relaxed">
            ...
            <TermsSection
              ...
              content={
                <>
                  <h4 className="font-semibold text-charcoal mb-2">Our Intellectual Property</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Your Content</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
            ...
            <TermsSection
              ...
              content={
                <>
                  <div className="bg-cream rounded-xl p-6 border border-charcoal/5 mb-4">
            ...
            <TermsSection
              ...
              content={
                <>
                  <h4 className="font-semibold text-charcoal mb-2">Termination by You</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Termination by Us</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Effect of Termination</h4>
                  <p className="text-charcoal/80 leading-relaxed">
            ...
            <TermsSection
              ...
              content={
                <>
                  <h4 className="font-semibold text-charcoal mb-2">Informal Resolution</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Arbitration</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Class Action Waiver</h4>
                  <p className="text-charcoal/80 leading-relaxed mb-4">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Governing Law</h4>
                  <p className="text-charcoal/80 leading-relaxed">
