      ...
      <div className="min-h-screen bg-cream flex">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-charcoal/60">Loading gift cards...</p>
          </div>
        </main>
      </div>
    );
      ...
      <div className="min-h-screen bg-cream flex">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center bg-white p-8 rounded-2xl shadow-soft max-w-md">
            ...
            <h2 className="text-xl font-semibold text-charcoal mb-2">Failed to load gift cards</h2>
    ...
    <div className="min-h-screen bg-cream flex">
        ...
        <header className="bg-white border-b border-charcoal/10 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-charcoal">Gift Cards</h1>
            </div>
            <div className="flex items-center gap-3">
              <button
                onClick={() => setShowBalanceModal(true)}
                className="flex items-center gap-2 px-4 py-2 border border-charcoal/20 rounded-xl font-medium hover:border-sage transition-colors"
              >
        ...
        <div className="flex-1 p-6 overflow-auto">
          <FeatureGate feature="gift_cards">
            ...
            <div className="bg-gradient-to-br from-sage/10 to-lavender/10 rounded-2xl p-6 border border-sage/20 mb-6">
              <h3 className="font-semibold text-charcoal mb-2">Share Your Gift Card Store</h3>
              <p className="text-sm text-charcoal/60 mb-4">Let clients purchase gift cards online anytime</p>
              <div className="flex gap-3 flex-wrap">
                <input
                  type="text"
                  value={shareUrl}
                  readOnly
                  className="flex-1 min-w-[200px] px-4 py-3 rounded-xl bg-white border border-charcoal/10 text-charcoal/70 text-sm"
                />
                <button
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-white border border-charcoal/20 rounded-xl font-medium hover:border-sage transition-colors"
                >
            ...
            {/* Quick Tips */}
            <div className="bg-white rounded-2xl p-6 border border-charcoal/5 shadow-soft mb-6">
              <h3 className="font-semibold text-charcoal mb-3">Gift Card Tips</h3>
            ...
            <div className="bg-white rounded-2xl border border-charcoal/5 shadow-soft">
              <div className="p-6 border-b border-charcoal/10">
                <h2 className="text-lg font-semibold text-charcoal">All Gift Cards</h2>
                <p className="text-sm text-charcoal/60">Track and manage gift card balances</p>
              </div>

              {giftCards.length === 0 ? (
                <div className="p-12 text-center">
                  <Gift className="w-12 h-12 text-charcoal/20 mx-auto mb-4" />
                  <p className="text-charcoal/60 mb-4">No gift cards yet</p>
                  <button
                    onClick={() => setShowModal(true)}
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-charcoal/10">
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Code</th>
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Amount</th>
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Balance</th>
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Recipient</th>
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Status</th>
                        <th className="text-left px-6 py-4 text-sm font-semibold text-charcoal/60">Date</th>
                      ...
                      {giftCards.map((card) => {
                        ...
                        return (
                          <tr key={card.id} className="hover:bg-cream/50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-charcoal/60">{formatDate(card.purchasedAt)}</td>
                            <td className="px-6 py-4 text-right relative">
                              ...
                              {actionMenu === card.id && (
                                <div className="absolute right-6 top-full mt-1 w-48 bg-white rounded-xl shadow-lg border border-charcoal/10 py-2 z-10">
                                  <button
        ...
        <div className="fixed inset-0 bg-charcoal/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-charcoal/10 flex items-center justify-between sticky top-0 bg-white">
              <h2 className="text-xl font-semibold text-charcoal">Create Gift Card</h2>
              <button onClick={() => { setShowModal(false); resetForm(); }} className="p-2 hover:bg-charcoal/5 rounded-lg">
            ...
            <div className="p-6 space-y-6">
              {/* Amount Selection */}
              <div>
                <label className="block text-sm font-medium text-charcoal mb-3">Gift Card Amount</label>
              ...
              {/* Purchaser Info */}
              <div>
                <label className="block text-sm font-medium text-charcoal mb-2">Purchaser Email</label>
                <input
                  type="email"
              ...
              {/* Delivery Method */}
              <div>
                <label className="block text-sm font-medium text-charcoal mb-3">Delivery Method</label>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <Mail className={`w-6 h-6 ${formData.deliveryMethod === 'email' ? 'text-sage' : 'text-charcoal/40'}`} />
                    <span className="font-medium text-charcoal">Email</span>
                    <span className="text-xs text-charcoal/60">Send digitally</span>
                  </button>
                  <button
                  ...
                  >
                    <Printer className={`w-6 h-6 ${formData.deliveryMethod === 'print' ? 'text-sage' : 'text-charcoal/40'}`} />
                    <span className="font-medium text-charcoal">Print</span>
                    <span className="text-xs text-charcoal/60">Physical card</span>
                  </button>
                </div>
              </div>
              ...
              {formData.deliveryMethod === 'email' && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-2">Recipient Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-2">Recipient Email</label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-2">Personal Message (optional)</label>
                    <textarea
        ...
        <div className="fixed inset-0 bg-charcoal/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            <div className="p-6 border-b border-charcoal/10 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-charcoal">Check Gift Card Balance</h2>
              <button onClick={() => { setShowBalanceModal(false); resetBalanceModal(); }} className="p-2 hover:bg-charcoal/5 rounded-lg">
                <X className="w-5 h-5 text-charcoal/60" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-charcoal mb-2">Gift Card Code</label>
                <input
                  type="text"
                  placeholder="Enter gift card code"
                  value={balanceCode}
                  onChange={(e) => setBalanceCode(e.target.value.toUpperCase())}
                  className="w-full px-4 py-3 border border-charcoal/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-sage/30 focus:border-sage font-mono"
                />
              </div>
      ...
      {showRedeemModal && (
        <div className="fixed inset-0 bg-charcoal/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            <div className="p-6 border-b border-charcoal/10 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-charcoal">Redeem Gift Card</h2>
              <button onClick={() => { setShowRedeemModal(false); resetRedeemModal(); }} className="p-2 hover:bg-charcoal/5 rounded-lg">
                <X className="w-5 h-5 text-charcoal/60" />
              </button>
            </div>
      ...
      {showDetailsModal && selectedCard && (
        <div className="fixed inset-0 bg-charcoal/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-charcoal/10 flex items-center justify-between sticky top-0 bg-white">
              <h2 className="text-xl font-semibold text-charcoal">Gift Card Details</h2>
              <button onClick={() => { setShowDetailsModal(false); setSelectedCard(null); }} className="p-2 hover:bg-charcoal/5 rounded-lg">
                <X className="w-5 h-5 text-charcoal/60" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-charcoal/5 rounded-xl p-4">
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium capitalize ${
                    ...
                    mapStatus(selectedCard.status) === 'cancelled' ? 'bg-red-100 text-red-700' :
                    'bg-charcoal/10 text-charcoal/60'
                  }`}>
                ...
                <div className="bg-charcoal/5 rounded-xl p-4">
                  <p className="text-xs text-charcoal/60 uppercase tracking-wide mb-1">Purchased</p>
                  <p className="text-sm font-medium text-charcoal">{new Date(selectedCard.purchasedAt).toLocaleDateString()}</p>
                </div>
                <div className="bg-charcoal/5 rounded-xl p-4">
                  <p className="text-xs text-charcoal/60 uppercase tracking-wide mb-1">Expires</p>
              ...
              {(selectedCard.recipientName || selectedCard.recipientEmail) && (
                <div className="border border-charcoal/10 rounded-xl p-4">
                  <p className="text-xs text-charcoal/60 uppercase tracking-wide mb-2">Recipient</p>
                  {selectedCard.recipientName && (
                    <p className="font-medium text-charcoal">{selectedCard.recipientName}</p>
                  )}
                  {selectedCard.recipientEmail && (
                    <p className="text-sm text-charcoal/60">{selectedCard.recipientEmail}</p>
                  )}
                </div>
              )}
              ...
              {selectedCard.purchaserEmail && (
                <div className="border border-charcoal/10 rounded-xl p-4">
                  <p className="text-xs text-charcoal/60 uppercase tracking-wide mb-2">Purchaser</p>
                  <p className="text-sm text-charcoal">{selectedCard.purchaserEmail}</p>
                </div>
              )}
              ...
              {selectedCard.message && (
                <div className="border border-charcoal/10 rounded-xl p-4">
                  <p className="text-xs text-charcoal/60 uppercase tracking-wide mb-2">Personal Message</p>
                  <p className="text-charcoal italic">"{selectedCard.message}"</p>
                </div>
              )}
            </div>
