 ...
 */
clientPortalRouter.get('/dashboard', async (req, res, next) => {
  try {
 ...
 */
clientPortalRouter.get('/appointments', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
 ...
 */
clientPortalRouter.post('/appointments/:id/cancel', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
    const { id } = req.params;
 ...
 */
clientPortalRouter.post('/booking', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
 ...
 * Get client profile
 */
clientPortalRouter.get('/profile', async (req, res, next) => {
  try {
 ...
 */
clientPortalRouter.put('/profile', async (req, res, next) => {
  try {
    const { id: clientId } = (req as any as AuthenticatedClientRequest).client;
 ...
 */
clientPortalRouter.get('/packages', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
 ...
 */
clientPortalRouter.post('/reviews', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
 ...
 */
clientPortalRouter.get('/services', async (req, res, next) => {
  try {
 ...
 */
clientPortalRouter.get('/staff', async (req, res, next) => {
  try {
    const { salonId } = (req as any as AuthenticatedClientRequest).client;
 ...
 */
clientPortalRouter.get('/appointments/:id/ics', async (req, res, next) => {
  try {
    const { id: clientId, salonId } = (req as any as AuthenticatedClientRequest).client;
    const { id } = req.params;
