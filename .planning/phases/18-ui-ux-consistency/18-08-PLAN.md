...
<task type="auto">
  ...
  <verify>
    ...
    - grep -A5 "<Modal" apps/web/src/app/packages/page.tsx | grep "isOpen=" shows Modals wired to state
...
<task type="auto">
  ...
  <verify>
    ...
    - grep -A5 "<Modal" apps/web/src/app/services/page.tsx | grep "isOpen=" shows Modals wired to state
    - npm run typecheck passes
  </verify>
