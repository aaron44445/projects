...
<task type="auto">
  ...
  <files>apps/api/src/routes/locations.ts, apps/web/src/app/services/page.tsx</files>
  <action>
...
- Service no longer has location-specific settings
  ...
  <done>Services can be enabled/disabled per location and reset to defaults</done>
</task>
...
6. Reset Location A overrides
7. Verify Location A shows service at $100 (base price)
...
- Booking widget respects location-specific service availability
</success_criteria>
