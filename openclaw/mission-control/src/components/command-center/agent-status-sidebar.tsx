  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2.5">
        {AGENTS.map((agent) => {
          ...
          return (
            <div
              key={agent.id}
              className="rounded-lg border border-[#2a2a3e] bg-[#111118] p-3.5 hover:border-[#3a3a4e] transition-colors"
            >
              <div className="flex items-start gap-3.5">
                {/* Sprite — larger preview */}
                <div className="rounded-md bg-[#0a0a0f] border border-[#1a1a2e] p-1.5">
                  <SpritePreview agentId={agent.id} size={56} />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span
                      className="font-[family-name:var(--font-pixel)] text-[11px] tracking-wide"
                  ...
                  {/* Agent ID */}
                  <div className="font-mono text-[10px] text-[#666680] mt-0.5">
                    {agent.id}
                  </div>

                  {/* Current task */}
                  <div className="mt-2 font-mono text-[11px] text-[#8a8aaa] truncate">
      ...
      <div className="px-4 py-3 border-t border-[#2a2a3e] flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="font-mono text-[10px] text-[#555566]">ACTIVE</span>
          <span className="font-[family-name:var(--font-pixel)] text-[10px] text-[#ffa500]">
